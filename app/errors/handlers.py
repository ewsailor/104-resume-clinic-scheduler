...
# ===== 本地模組 =====
from app.errors.exceptions import (  # CRUD 層級; Router 層級; Service 層級; System 層級; AuthenticationError,; AuthorizationError,; BadRequestError,; BusinessLogicError,; ConflictError,; ScheduleCannotBeDeletedError,; ScheduleNotFoundError,; ScheduleOverlapError,; UserNotFoundError,; ValidationError,
    DatabaseError,
